...
import com.fitnessApp.fitnessapp.model.ProgressLog;
import com.fitnessApp.fitnessapp.model.User;
import com.fitnessApp.fitnessapp.repository.ProgressLogRepository;
import com.fitnessApp.fitnessapp.repository.UserRepository;
import com.fitnessApp.fitnessapp.service.ReviewService;
...
public class UserController {
    ...
    public ResponseEntity<?> createClient(@RequestBody UserDto clientDto) {
        ...
        client.setRole(com.fitnessApp.fitnessapp.model.Role.PREMIUM_CLIENT);
    ...
    public ResponseEntity<?> uploadInitialPhoto(@org.springframework.web.bind.annotation.RequestParam("file") org.springframework.web.multipart.MultipartFile file,
        ...
        User user = userRepository.findByEmail(principal)
                .or(() -> userRepository.findByUsername(principal))
                .orElseThrow(() -> new ResponseStatusException(HttpStatus.UNAUTHORIZED, "Usuario no encontrado."));
        com.fitnessApp.fitnessapp.model.ReviewImage saved = reviewService.addStandaloneImage(user, view, file);
        Map<String, Object> body = new HashMap<>();
