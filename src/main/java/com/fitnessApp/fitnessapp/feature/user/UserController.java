package com.fitnessApp.fitnessapp.feature.user;

import com.fitnessApp.fitnessapp.feature.review.ReviewImage;
import com.fitnessApp.fitnessapp.feature.progress.ProgressLog;
import com.fitnessApp.fitnessapp.feature.progress.ProgressLogRepository;
import com.fitnessApp.fitnessapp.feature.review.ReviewService;
...
public class UserController {
    ...
    public ResponseEntity<?> uploadInitialPhoto(@org.springframework.web.bind.annotation.RequestParam("file") org.springframework.web.multipart.MultipartFile file,
        ...
        User user = userRepository.findByEmail(principal)
                .or(() -> userRepository.findByUsername(principal))
                .orElseThrow(() -> new ResponseStatusException(HttpStatus.UNAUTHORIZED, "Usuario no encontrado."));
        ReviewImage saved = reviewService.addStandaloneImage(user, view, file);
        Map<String, Object> body = new HashMap<>();
